(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=new Map,t=new Map;function n(n,r,i){e.set(n,r),i&&t.set(n,i)}function r(e){return e===`home`?`/`:`/${e}`}function i(e){return e.replace(/^\//,``)||`home`}function a(n,r){let i=e.has(n)?n:`home`,a=document.getElementById(`main-content`);a.innerHTML=e.get(i)(),t.get(i)?.(),r?document.getElementById(r)?.scrollIntoView({behavior:`smooth`}):window.scrollTo({top:0,behavior:`instant`})}function o(e,t){history.pushState({route:e,scrollTarget:t},``,r(e)),a(e,t)}function s(){window.addEventListener(`popstate`,e=>{a(e.state?.route??i(location.pathname),e.state?.scrollTarget)}),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-route]`);t&&(e.preventDefault(),o(t.dataset.route,t.dataset.scroll))});let e=i(location.pathname);history.replaceState({route:e},``,r(e)),a(e)}function c(){return`
  ...
  `}function b(){let e=document.getElementById(`contact-form`),t=document.getElementById(`contact-submit`),n=document.getElementById(`contact-feedback`);e.addEventListener(`submit`,async r=>{r.preventDefault(),t.disabled=!0,t.textContent=`Sending…`,n.hidden=!0,n.className=`contact-feedback`;let i=new FormData(e),a={first_name:i.get(`first_name`),last_name:i.get(`last_name`),email:i.get(`email`),phone:i.get(`phone`),subject:i.get(`subject`),message:i.get(`message`)};try{if((await fetch(`https://api.merelscapital.com/contact`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(a)})).ok)n.textContent=`Your message has been sent. We'll be in touch shortly.`,n.classList.add(`contact-feedback--success`),e.reset(),t.textContent=`Message Sent`;else throw Error(`Server error`)}catch{n.textContent=`Something went wrong. Please try again or email us directly at info@merelscapital.com.`,n.classList.add(`contact-feedback--error`),t.disabled=!1,t.textContent=`Send Message`}n.hidden=!1})}function x(){return`
    <section class="split-hero">
      <div class="split-hero-left">
        <div class="split-hero-content">
  ...
  `}n(`home`,c,u),n(`about`,d),n(`individuals`,f),n(`family-offices`,p),n(`small-businesses`,m),n(`articles`,h),n(`articles/gold-2025`,g),n(`articles/private-credit-2026`,_),n(`articles/usd-2026`,v),n(`articles/energy-2026`,y),n(`contact`,x,b),document.getElementById(`header`).innerHTML=S(),document.getElementById(`footer`).innerHTML=C();var w=document.getElementById(`header`);window.addEventListener(`scroll`,()=>{w.classList.toggle(`scrolled`,window.scrollY>10)},{passive:!0});var T=document.getElementById(`mobile-menu-btn`),E=document.getElementById(`nav-links`),D=document.getElementById(`nav-actions`);T.addEventListener(`click`,()=>{let e=E.classList.toggle(`open`);D.classList.toggle(`open`,e),T.setAttribute(`aria-label`,e?`Close menu`:`Open menu`)});var O=document.getElementById(`book-now-btn`),k=document.getElementById(`booking-modal`),A=document.getElementById(`booking-modal-close`),j=k.querySelector(`.booking-modal-backdrop`),M=document.getElementById(`booking-iframe`),N=!1;function P(){N||=(M.src=`https://bookings.merelscapital.com`,!0),k.hidden=!1,document.body.style.overflow=`hidden`}O.addEventListener(`click`,P),document.addEventListener(`click`,e=>{e.target.closest(`[data-action="open-booking"]`)&&P()});function F(){k.hidden=!0,document.body.style.overflow=``}A.addEventListener(`click`,F),j.addEventListener(`click`,F),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&F()}),s();function I(){let e=[],t=new Date;for(;e.length<5;){t.setDate(t.getDate()+1);let n=t.toLocaleDateString(`en-CA`,{timeZone:`America/Denver`}),[r,i,a]=n.split(`-`).map(Number),o=new Date(r,i-1,a).getDay();o!==0&&o!==6&&e.push(n)}e.forEach(e=>fetch(`https://api.merelscapital.com/slots?date=${e}`).catch(()=>{}))}window.addEventListener(`load`,()=>{(window.requestIdleCallback??(e=>setTimeout(e,200)))(I)});